...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 29 10:54:53 2020
...
def model_inputs(real_dim, z_dim):
    print('model inputs')
    inputs_real = tf.placeholder(tf.float32, (None, real_dim[0], real_dim[1],real_dim[2]), name='inputs_real')
